      ...
      <section>
        ...
        <header>
          ...
          <ul className="navigation">
            ...
            <li><a href="#">Menu</a></li>
            <li><a href="/Calculator/calci.html">Calculator</a></li>
        ...
        <div className="buttons">
          <div className="textBox">
            ...
            <div>
              <a href="http://127.0.0.1:5000" className="button">
              ...
              <a href="/game" className="button">
                <span className="front">
                  <i className="fa fa-trophy" aria-hidden="true"></i> GAME
                </span>
                <span className="center"></span>
                <span className="back">
                  <i className="fa fa-trophy" aria-hidden="true"></i> GAME
              ...
              <a href="https://gptgo.ai/en" className="button">
                <span className="front">
                  <i className="fa fa-commenting" aria-hidden="true"></i> GPT
                </span>
                <span className="center"></span>
                <span className="back">
                  <i className="fa fa-commenting" aria-hidden="true"></i> GPT
